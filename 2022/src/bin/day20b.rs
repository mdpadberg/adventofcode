...
fn calculate_new_index(
    ...
    (current_index as i64 + value_of_current_index * 811589153).rem_euclid(length_of_vec as i64 - 1)
}
...
mod test {
    ...
    #[test]
    fn solvetest() {
        assert_eq!(1623178306, solve(read_test_data_for_day(20).unwrap()));
    }
}
