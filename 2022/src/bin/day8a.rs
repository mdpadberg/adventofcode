...
fn solve(input: String) -> usize {
    ...
    let mut tree_visable_from_outside = 0;
...
mod test {
    ...
    // Output (21 trees are visible from outside the grid)
    // 30373
    // 255 2
    // 65 32
    // 3 5 9
    ...
    #[test]
    fn solvetest() {
        assert_eq!(21, solve(read_test_data_for_day("8-0").unwrap()));
    }
