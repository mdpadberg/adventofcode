...
fn main() {
    ...
    //cargo run --bin day13 --release
    //execution took 0.97ms
}
...
mod test {
    ...
    fn create_transparent_paper() {
        ...
        assert_eq!(expected, TransparentPaper::new(test_data()));
    }

    #[test]
    fn transparent_paper_fold() {
        let mut transparent_paper = TransparentPaper::new(test_data());
        transparent_paper.fold_once();
        assert_eq!(
            vec![
                (0, 0),
