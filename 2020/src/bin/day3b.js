const input = require('fs').readFileSync('2020/data/3.txt', 'utf8').split('\n');

console.log(calculateAmountOfTrees(1, 1) * calculateAmountOfTrees(3, 1) * calculateAmountOfTrees(5, 1) * calculateAmountOfTrees(7, 1) * calculateAmountOfTrees(1, 2));
